...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexSiege = /^\/siege/; botRegexOW = /^\/ratings/; botRegexStands = /^\/standings/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("www.daddyleagues.com/snd/players/");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/spreadsheets/d/1RSERYbwoVedvA-4fBWzhobm6lRo-abcBko_AhUX4HWY/edit#gid=1262559733");
    this.res.end();
  }
